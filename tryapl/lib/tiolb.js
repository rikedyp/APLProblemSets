...
let upd=_=>{d.body.style.marginTop=lb.clientHeight+'px';session.style.height="calc(100vh - 7px - " + lb.clientHeight+'px)';$$(".content").forEach(fn=node=>{node.style.height="calc(100vh - 2.6em - " + lb.clientHeight+'px)'})}
