...
NAME("Tilde Diaeresis"),CHAR("⍨"),TIP(
                        _("Monadic operator: Commute (Switch)")
                        _("")
                        _("      2 ⍴ 3     ⍝ ⍺ ⍴ ⍵")
                        _("3 3")
                        _("      2 ⍴⍨ 3    ⍝ ⍵ ⍴ ⍺")
...
NAME("Jot"),CHAR("∘"),TIP(
                        _("Dyadic operator: Compose")
                        _("")
                        _("NB: ∘ is also used in outer product ∘.f - see Dot (.)")
                        _("")
                        _("Form f∘g (function composition)")
                        _("")
                        _("      ⌽∘⍳¨ 3 4 5")
                        _("┌─────┬───────┬─────────┐")
                        ...
                        _("1.61803")
                        _("")
                        _("Form A∘g (left argument currying)")
                        _("")
                        _("       next ← 1∘+")
                        _("       next 23")
                        _("24")
                        _("")
                        _("Form f∘B (right argument currying)")
                        _("")
                        _("      prev ← -∘1")
                        _("      prev 23")
                        _("22")
